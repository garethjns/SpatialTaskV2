function stats = fitGLMLinear(allData)
...
if ~isempty(data)
    ...
    stats.ACorr.Coefficients.Estimate = [NaN, NaN, NaN];
    stats.ACorr.Coefficients.pValue = [NaN, NaN, NaN];
    stats.VCorr.Coefficients.Estimate = [NaN, NaN, NaN];
    stats.VCorr.Coefficients.pValue = [NaN, NaN, NaN];
end
